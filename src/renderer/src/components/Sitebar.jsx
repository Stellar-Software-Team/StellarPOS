...
function Sitebar() {
  ...
  return (
    <>
      <div className="space-y-3 w-24 h-full flex items-center bg-[#191A19] text-white">
        <div className="flex flex-col ml-4">
          {/* <img src={logoIcon} className='-mt-52 ml-4 w-12 h-12'/> */}
          <ul className="span-rows-2 pt-2 pb-4 space-y-16 text ">
