          ...
          <section className='m-6 flex flex-col '>
            <div>
                  ...
                  <div className='flex flex-row '>
                    <div className='flex flex-row items-center gap-4 cursor-pointer '>
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                        ...
                        <div className='bg-gray-100 rounded-lg p-2 w-10 h-10 flex justify-center items-center hover:bg-gray-200'><span>1</span></div>
                        <div className='bg-gray-100 rounded-lg p-2 w-10 h-10 flex justify-center items-center hover:bg-gray-200'><span>2++</span></div>
                ...
                <div className='mt-20 flex flex-wrap gap-2 overflow-auto'>
                  {
                    employees.map((employee)=><EmployeeCard props={employee}/>
                  )
                  }
