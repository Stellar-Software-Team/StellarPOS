  ...
  return (
    <div className='w-96 h-[26rem] bg-white shadow-xl rounded-3xl flex flex-col p-2'>
        ...
        </section>
        {
            ...
            <div className='flex flex-row gap-2 h-full items-center basis-[10%] mx-2'>
            ...
            <div className='basis-[90%] '><Button fullWidth  className='flex flex-row gap-2 justify-center items-center'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
