                ...
                defaultChecked
                  label={
                    <div>
                      ...
                      <Typography variant="small" color="gray" className="font-normal">
                        Option to create a resume after closing a cash register with the totalof sales, cash earned, etc.
                      </Typography>
                    </div>
                  }
                  containerProps={{
               ...
               <h1 className="font-bold text-lg">General Set up</h1>
                ...
                label={
                  <div>
                    ...
                    <Typography variant="small" color="gray" className="font-normal">
                      it's needed to set a time for automaticly open the service register. Default is 8:00 AM to 8:00 PM
                    </Typography>
                  </div>
                }
                containerProps={{
