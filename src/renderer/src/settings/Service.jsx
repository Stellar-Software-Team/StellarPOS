				...
				<section className="flex flex-col space-y-8 overflow-auto h-[54rem] custom-scrollbar">
					<div className="bg-white rounded-2xl shadow-md p-6">
						...
						<span className="text-gray-500">
							Set a Cash Register Configuration
						</span>
						...
						<div className="grid grid-cols-2 gap-6 mt-8">
							<div className="grid gap-2">
									...
									<Checkbox
										label={
											<div>
												...
												>
													it's needed to set a time for automaticly open the
													cash register. Default is 8:00 AM to 8:00 PM
												</Typography>
											</div>
										}
										containerProps={{
								...
								<div className="flex space-x-16 items-center">
									...
									<div>
										<h1 className="text-gray-800 text-md">
											Close General cash register at:
										</h1>
										<input
											type="time"
											className="px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
										...
										label={
											<div>
												...
												<Typography
													...
													className="font-normal"
												>
													Option to reconcile cash between cash register and the
													sales total
												</Typography>
											</div>
										}
										...
										label={
											<div>
												...
												<Typography
													...
													className="font-normal"
												>
													This will set the work schedule in the morning and
													evening
												</Typography>
											</div>
										}
								...
								<div>
									...
									<Checkbox
										...
										label={
											<div>
												<Typography color="blue-gray" className="font-medium">
													Automaticly create a resume after closing a cash
													register
												</Typography>
												<Typography
													variant="small"
													...
													className="font-normal"
												>
													Option to create a resume after closing a cash
													register with the totalof sales, cash earned, etc.
												</Typography>
											</div>
										}
										containerProps={{
					...
					<div className="bg-white rounded-2xl shadow-md p-6">
						...
						<span className="text-gray-500">
							Set a Service Register Configuration
						</span>
						...
						<div className="grid grid-cols-2 gap-6 mt-8">
							<div className="grid gap-2">
								<div>
									...
									<Checkbox
										label={
											<div>
												<Typography color="blue-gray" className="font-medium">
													Automaticly open General service register at certain
													time
												</Typography>
												<Typography
													variant="small"
												...
												>
													it's needed to set a time for automaticly open the
													service register. Default is 8:00 AM to 8:00 PM
												</Typography>
											</div>
										}
										containerProps={{
								...
								<div className="flex space-x-16 items-center">
									<div>
										<h1 className="text-gray-800 text-md">
											Open General service register at:
										</h1>
										<input
											type="time"
											className="px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
									...
									<div>
										<h1 className="text-gray-800 text-md">
											Close General service register at:
										</h1>
										<input
											type="time"
											className="px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
