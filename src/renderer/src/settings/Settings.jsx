...
function Settings() {
  const labels = ['General', 'Account', 'Apparence', 'Notifications', 'Advanced Settings']
        ...
        <aside className="w-60 flex-col border-r md:flex">
          ...
          <nav className="gap-2 flex flex-col">
            ...
            <Link
              ...
              className="flex items-center gap-2 rounded-md px-3 py-2 text-lg  transition-colors hover:bg-muted hover:text-foreground"
            >
             <svg fill="#000000" height="23px" width="23px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
