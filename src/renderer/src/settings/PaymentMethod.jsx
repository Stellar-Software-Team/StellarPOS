			...
			<section className="flex flex-col space-y-8 overflow-auto h-[54rem] custom-scrollbar">
				<div className="bg-white rounded-2xl shadow-md p-6">
					...
					<span className="text-gray-500">
						Update your Payment Method configuration
					</span>
								...
								label={
									<div>
										...
										<Typography
											...
											className="font-normal"
										>
											This option will allow the clients to pay with currencies
									...
									label={
										<div>
											...
											<Typography
												...
												className="font-normal"
											>
												This option will set the currency conversion according
												to your configurations instead of your business location
											</Typography>
										</div>
									}
									containerProps={{
				...
				<div className="bg-white rounded-2xl shadow-md p-6">
					...
					<span className="text-gray-500">
						Configure discounts for your payment methods{' '}
					</span>
				...
				<div className="bg-white rounded-2xl shadow-md p-6">
					...
					<span className="text-gray-500">
						Configure Invoice settings for your clients{' '}
					</span>
								...
								label={
									<div>
										...
										<Typography
											...
											className="font-normal"
										>
											This option will allow the cashier to provide invoices to
											the customers.
										</Typography>
									</div>
								}
