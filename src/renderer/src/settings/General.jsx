                ...
                <Checkbox
                  ...
                  label={
                    <div>
                      ...
                      <Typography variant="small" color="gray" className="font-normal">
                        This option will ask for a 4-Digits Pin for Admin Actions like reset
                        password, create new employee, etc.
                      </Typography>
                    </div>
                  }
                  containerProps={{
                ...
                <Checkbox
                  ...
                  label={
                    <div>
                      ...
                      <Typography variant="small" color="gray" className="font-normal">
                        This option will allows you to close any session remotely from your
                        computer.
                      </Typography>
                    </div>
                  }
