			...
			<section className="flex flex-col space-y-8 overflow-auto h-[54rem] custom-scrollbar">
				...
				<div className="bg-white rounded-2xl shadow-md p-6">
					...
					<span className="text-gray-500">
						Customize your receipt preferences
					</span>
				...
				<div className="bg-white rounded-2xl shadow-md p-6">
					...
					<span className="text-gray-500">
						Update Login Settings & Security
					</span>
					...
					<div className="grid grid-cols-2 gap-6 mt-8">
						...
						<div className="grid gap-2 ">
							<h1 className="font-bold text-lg">
								Security 4-Digits Pin for Admin Actions
							</h1>
							<div>
								{' '}
								<Checkbox
									...
									label={
										<div>
											...
											<Typography
												...
												className="font-normal"
											>
												This option will ask for a 4-Digits Pin for Admin
												Actions like reset password, create new employee, etc.
											</Typography>
										</div>
									}
									containerProps={{
						...
						<div className="grid gap-2 items-center">
							...
							<section className="flex flex-col gap-2 ">
								...
								<div className="flex items-center gap-2">
									...
									<span className="text-black text-xl font">
										Historical changes
									</span>
								</div>
							</section>
									...
									label={
										<div>
											...
											<Typography
												...
												className="font-normal"
											>
												This option will allows you to close any session
