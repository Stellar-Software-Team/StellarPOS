		...
		<>
			...
			<div className="flex flex-col h-[92%] overflow-auto overflow-y-scroll custom-scrollbar">
				<div className="h-[20%] items-center grid grid-cols-4 space-x-2">
					<MiniDisplay
						data={{ icon: 'sales', quantity: '671', desc: "Today's Sales" }}
					/>
					<MiniDisplay
						data={{
							icon: 'cash',
					...
					/>
					<MiniDisplay
						data={{ icon: 'tips', quantity: '$ 165.00', desc: "Today's Tips" }}
					/>
					<MiniDisplay
						data={{ icon: 'clients', quantity: '132', desc: "Today's Clients" }}
					/>
				</div>
				...
				<div className="mt-24 grid grid-cols-4 gap-2">
					<div className="bg-gray-100 h-60  flex flex-col justify-center items-center rounded-3xl shadow-md">
						...
						<span className="flex ml-4 mb-4 text-lg font-semibold">
							Top 5 best products
						</span>
					</div>
					...
					<div className="bg-gray-100 h-60 rounded-xl shadow-md">
						<div className="flex flex-row m-4 ">
							<span className="text-md font-semibold basis-2/3 ml-6">
								Average Income per Hour
							</span>
							<span className="flex basis-1/3 text-gray-700 ml-24">
								{' '}
								View All{' '}
							</span>
						</div>
